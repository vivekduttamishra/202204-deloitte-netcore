...
namespace WebAppSHA01
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                await context.Response.WriteAsync($"Long running The work started -  {DateTime.Now.ToLongTimeString()}");
                await Task.Delay(2000);
                await context.Response.WriteAsync($"Long running workd finished -  {DateTime.Now.ToLongTimeString()}");
